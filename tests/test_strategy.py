...
class ExcludedMarketTests(unittest.TestCase):
    ...
    def test_youtube_view_count_markets_banned(self):
        # User rule 2026-06-14 (lost a MrBeast view-count bet): YouTube
        # view/subscriber-count markets are banned.
        for market in (
    ...
    def test_views_word_boundary_no_false_positives(self):
        # "reviews" / "interviews" must not trip the \\bviews\\b view-count rule.
        for market in (
            ...
            {"question": "Will France win on 2026-06-14?", "slug": "fra-win"},
        ):
            self.assertFalse(is_excluded_market(market), market["question"])
