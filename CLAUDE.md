...
- Bankroll: **$8.49 USDC** starting (post-bleed reset); sizing mirrors the dry-validated config — `stake_pct=0.25` (~$2.12/trade — clears Polymarket's $1 min), max position $6.37 (75% ceiling matches dry's $15-on-$20 ratio)
...
- Sizing (mirrors the dry-validated config — only absolute USD scaled for $8.49 bankroll): `starting_cash=8.49`, `assumed_live_balance_usd=8.49`, `stake_pct=0.25` (matches dry), `stake_usd=2.12` (~$2.12/trade, clears Polymarket's $1 min), `max_position_ceiling_usd=6.37` (75% — matches dry's $15-on-$20 ratio), `cash_floor_pct=0.02`, `min_open_positions=0`
