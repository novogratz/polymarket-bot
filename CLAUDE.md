...
- **Esports — LoL / Mobile Legends ONLY, LIVE GAMES ONLY (2026-06-12)**: only League of Legends ("LoL:") and Mobile Legends (MLBB) qualify, and only while the game is in progress (`gameStartTime` in the past, ≤ 8 h). **Every other title — Counter-Strike, Valorant, Dota, CS2, Rainbow Six, Rocket League, Overwatch, generic BO1/BO3/BO5 — is banned outright**, live or not. Pre-game or unknown start stays excluded for the allowed games too
