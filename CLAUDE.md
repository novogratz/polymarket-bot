...
- price (ask) ∈ **[0.80, 0.94]** with an absolute **hard cap 0.96** (`race_max_price_hard_cap`, user 2026-06-21 v4 — 0.97/0.98/0.99 never tradeable), **game STARTS or market CLOSES within ≤ 48 h** (48 h since 2026-07-19 — today's AND tomorrow's weather markets, doubling the simultaneous lines; 24 h 2026-07-06→07-19, 4 h before that). The dynamic widening ladder is disabled (`race_max_hours=48`, `race_max_hours_cap=0` → single `[48h]` window).
