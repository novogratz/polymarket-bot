...
- **Entry:** ask ∈ [0.85, 0.94], hard cap 0.96, resolves today or in 12–24h (never beyond 24h), spread ≤4¢. Narrow `between X–Y°` brackets are excluded. Open-Meteo is fail-closed, candidates rank by forecast edge, and fresh exposure is capped at two positions per broad region/date.
