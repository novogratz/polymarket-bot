...
- **Entry:** every lane uses asks ∈ [0.85, 0.97] and the 6h outer window. Weather targets the city's current local date after solar 15:00 and recovers still-open Gamma deadlines from the prior 24h. Sports must have started within six hours. BTC/SOL/XRP windowed direction contracts must close within one hour; objective hit/dip/above/below thresholds enter in their final three hours; economics within two hours. Range weather brackets are enabled and distinct brackets may each be held.
