...
class Settings:
    ...
    trade_fraction: float = _float_env("POLYMARKET_TRADE_FRACTION", 0.50)
    ...
    smart_trade_lookback_minutes: int = _int_env("POLYMARKET_SMART_TRADE_LOOKBACK_MINUTES", 60)
    smart_min_consensus: int = _int_env("POLYMARKET_SMART_MIN_CONSENSUS", 1)
    ...
    smart_max_trade_usd: float = _float_env("POLYMARKET_SMART_MAX_TRADE_USD", 50.0)
