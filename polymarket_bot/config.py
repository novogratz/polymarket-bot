...
class Settings:
    ...
    race_weather_min_solar_hour: float = field(default_factory=lambda: _float_env("POLYMARKET_RACE_WEATHER_MIN_SOLAR_HOUR", 0.0))
    race_weather_calibration_min_samples: int = field(default_factory=lambda: _int_env("POLYMARKET_RACE_WEATHER_CALIBRATION_MIN_SAMPLES", 0))
    race_weather_calibration_max_brier: float = field(default_factory=lambda: _float_env("POLYMARKET_RACE_WEATHER_CALIBRATION_MAX_BRIER", 0.0))
