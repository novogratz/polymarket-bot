...
class Settings:
    ...
    min_open_positions: int = _int_env("POLYMARKET_MIN_OPEN_POSITIONS", 6)
    ...
    smart_max_chase_premium: float = _float_env("POLYMARKET_SMART_MAX_CHASE_PREMIUM", 0.35)
    ...
    smart_leaderboard_position_enabled: bool = _bool_env("POLYMARKET_SMART_LEADERBOARD_POSITION_ENABLED", True)
    ...
    smart_top10_flow_enabled: bool = _bool_env("POLYMARKET_SMART_TOP10_FLOW_ENABLED", True)
    ...
    smart_liquidity_sizing_enabled: bool = _bool_env("POLYMARKET_SMART_LIQUIDITY_SIZING_ENABLED", True)
    smart_liquidity_sizing_haircut: float = _float_env("POLYMARKET_SMART_LIQUIDITY_SIZING_HAIRCUT", 0.85)
