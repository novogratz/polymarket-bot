...
_SCHEMA: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "mirror": {
        ...
        "copy_ratio": ("POLYMARKET_MIRROR_COPY_RATIO", "float"),
        "max_position_pct": ("POLYMARKET_MIRROR_MAX_POSITION_PCT", "float"),
        "max_open_positions": ("POLYMARKET_MIRROR_MAX_OPEN_POSITIONS", "int"),
        "max_category_exposure_pct": ("POLYMARKET_MIRROR_MAX_CATEGORY_EXPOSURE_PCT", "float"),
        "whale_exit_fraction": ("POLYMARKET_MIRROR_WHALE_EXIT_FRACTION", "float"),
        "daily_loss_limit_pct": ("POLYMARKET_MIRROR_DAILY_LOSS_LIMIT_PCT", "float"),
        "stop_loss_pct": ("POLYMARKET_MIRROR_STOP_LOSS_PCT", "float"),
        "stop_loss_min_age_minutes": ("POLYMARKET_MIRROR_STOP_LOSS_MIN_AGE_MINUTES", "int"),
        "resolved_exit_threshold": ("POLYMARKET_MIRROR_RESOLVED_EXIT_THRESHOLD", "float"),
        ...
        "discovery_enabled": ("POLYMARKET_MIRROR_DISCOVERY_ENABLED", "bool"),
        "discovery_interval_hours": ("POLYMARKET_MIRROR_DISCOVERY_INTERVAL_HOURS", "int"),
        "min_whale_pnl": ("POLYMARKET_MIRROR_MIN_WHALE_PNL", "float"),
    ...
    "quant_bitcoin": {
        "enabled": ("POLYMARKET_QUANT_BTC_ENABLED", "bool"),
        "symbol": ("POLYMARKET_QUANT_BTC_SYMBOL", "str"),
        "binance_url": ("POLYMARKET_QUANT_BTC_BINANCE_URL", "str"),
        "coinbase_url": ("POLYMARKET_QUANT_BTC_COINBASE_URL", "str"),
        "kraken_url": ("POLYMARKET_QUANT_BTC_KRAKEN_URL", "str"),
        "max_exchange_divergence_pct": ("POLYMARKET_QUANT_BTC_MAX_EXCHANGE_DIVERGENCE_PCT", "float"),
        "signal_path": ("POLYMARKET_QUANT_BTC_SIGNAL_PATH", "str"),
        "min_buy_price": ("POLYMARKET_QUANT_BTC_MIN_BUY_PRICE", "float"),
        "max_spread": ("POLYMARKET_QUANT_BTC_MAX_SPREAD", "float"),
        "max_relative_spread": ("POLYMARKET_QUANT_BTC_MAX_RELATIVE_SPREAD", "float"),
        "min_liquidity_usd": ("POLYMARKET_QUANT_BTC_MIN_LIQUIDITY_USD", "float"),
        "min_volume_usd": ("POLYMARKET_QUANT_BTC_MIN_VOLUME_USD", "float"),
        "min_hours_to_close": ("POLYMARKET_QUANT_BTC_MIN_HOURS_TO_CLOSE", "float"),
        "max_hours_to_close": ("POLYMARKET_QUANT_BTC_MAX_HOURS_TO_CLOSE", "float"),
        "risk_per_trade_pct": ("POLYMARKET_QUANT_BTC_RISK_PER_TRADE_PCT", "float"),
        "max_trade_usd": ("POLYMARKET_QUANT_BTC_MAX_TRADE_USD", "float"),
        "max_orders_per_tick": ("POLYMARKET_QUANT_BTC_MAX_ORDERS_PER_TICK", "int"),
        "hard_stop_loss_pct": ("POLYMARKET_QUANT_BTC_HARD_STOP_LOSS_PCT", "float"),
    },
    "noise_fallback": {
