...
_SCHEMA: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "race": {
        ...
        "tweet_max_hours": ("POLYMARKET_RACE_TWEET_MAX_HOURS", "float"),
        "edge_weighted_sizing": ("POLYMARKET_RACE_EDGE_WEIGHTED_SIZING", "bool"),
        "boxoffice_only": ("POLYMARKET_RACE_BOXOFFICE_ONLY", "bool"),
        "boxoffice_min_edge": ("POLYMARKET_RACE_BOXOFFICE_MIN_EDGE", "float"),
        "boxoffice_max_hours": ("POLYMARKET_RACE_BOXOFFICE_MAX_HOURS", "float"),
        "maker_entries": ("POLYMARKET_RACE_MAKER_ENTRIES", "bool"),
