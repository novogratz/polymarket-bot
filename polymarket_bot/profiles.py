...
_SCHEMA: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "race": {
        ...
        "weather_min_solar_hour": ("POLYMARKET_RACE_WEATHER_MIN_SOLAR_HOUR", "float"),
        "weather_calibration_min_samples": ("POLYMARKET_RACE_WEATHER_CALIBRATION_MIN_SAMPLES", "int"),
        "weather_calibration_max_brier": ("POLYMARKET_RACE_WEATHER_CALIBRATION_MAX_BRIER", "float"),
