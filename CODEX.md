...
**Entry:** all three live profiles admit asks through 0.97 with a matching hard cap and require at least +1 point of Open-Meteo edge (so a 0.97 ask needs model probability ≥0.98). Each scans 1,500 markets per ordering, admits $50+ daily volume, and has no broad region/date count ceiling. Markets resolve today or in 12–24h (never beyond 24h), with spread ≤4¢. Narrow ranges are excluded; Open-Meteo validation fails closed and candidates rank by forecast edge.
