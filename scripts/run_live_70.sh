...
export POLYMARKET_SMART_MAX_TRADE_USD=12
export POLYMARKET_SMART_HIGH_CONVICTION_BALANCE_FRACTION=0.25
export POLYMARKET_SMART_POSITION_PCT=0.30
...
export POLYMARKET_SMART_NOISE_FALLBACK_CASH_PRESSURE_PCT=0.20
