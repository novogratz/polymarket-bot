...
export POLYMARKET_SMART_NOISE_FALLBACK_MAX_TRADES_PER_TICK=8
export POLYMARKET_SMART_NOISE_FALLBACK_MAX_TRADE_USD=15
...
export POLYMARKET_SMART_NOISE_FALLBACK_CASH_PRESSURE_PCT=0.25
...
exec uv run python -B -m polymarket_bot.main auto-loop
