...
# Leaderboard sidecar with --auto-discover: every refresh rebuilds the
# strategy list from data/dry_runs/*, so auto_* bots spawned at runtime
# by the autonomous analyst show up automatically.
