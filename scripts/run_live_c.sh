...
# Bot 3 bankroll fallback = $285.95 (baseline reset 2026-07-28).
...
export POLYMARKET_PAPER_BALANCE_USD=${POLYMARKET_PAPER_BALANCE_USD:-285.95}
export POLYMARKET_ASSUME_LIVE_BALANCE_USD=${POLYMARKET_ASSUME_LIVE_BALANCE_USD:-285.95}
