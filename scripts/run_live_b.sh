...
# Refuse a second live loop on the same wallet; concurrent loops can submit
# the same candidate twice before either process sees the other's fill.
...
# Bot B bankroll fallback = $15 (re-baselined 2026-07-27).
